...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Sepatu</h1>
            <a href="{{ route('admin/sepatu/create') }}" class="btn btn-primary">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">DataTables Sepatu</h6>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @if ($sepatu->count() > 0)
                                @foreach ($sepatu as $item)
                                    <tr>
                                        <td>{{ $loop->iteration + ($sepatu->currentPage() - 1) * $sepatu->perPage() }}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin/sepatu/edit', $item->id) }}"
                                                class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                            <form action="{{ route('admin/sepatu/destroy', $item->id) }}"
                                                method="POST"
                            ...
                            @else
                                <tr>
                                    <td class="text-center" colspan="8">Data sepatu tidak ditemukan</td>
                                </tr>
                            @endif
                ...
                <div class="d-flex justify-content-center">
                    {{ $sepatu->links('pagination::bootstrap-4') }}
                </div>
            </div>
        </div>
    </div>
